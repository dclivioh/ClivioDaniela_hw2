...
ax.plot(t1,u1,c="mediumblue",label="Posicion u1 vs Tiempo para w1=0.3")
ax.set_xlabel("t")
ax.set_ylabel("u1(t)")
ax.legend()

ax2.plot(t2,u2,c="darkorange", label="Posicion u2 vs Tiempo para w2=0.5")
ax2.set_xlabel("t")
ax2.set_ylabel("u2(t)")
ax2.legend()

ax3.plot(t3,u3,c="mediumturquoise", label="Posicion u3 vs Tiempo para w3=0.6")
ax3.set_xlabel("t")
ax3.set_ylabel("u3(t)")
ax3.legend()

ax4.plot(t4,u4,c="blueviolet", label="Posicion u4 vs Tiempo para w4=1.0")
ax4.set_xlabel("t")
ax4.set_ylabel("u4(t)")
ax4.legend()
